...
require('run-series')([
  ...
  function(done) {
    benchmark('zlib.gzip()', zlib.gzip.bind(zlib, input), function(err, event) {
      if (err) {
        throw err
      }
  ...
  function(done) {
    benchmark('zlib.deflate()', zlib.deflate.bind(zlib, input), function(
      err,
      event
    ) {
      if (err) {
  ...
  function(done) {
    zlib.gzip(input, function(err, compressed) {
      ...
      benchmark('zlib.gunzip()', zlib.gunzip.bind(zlib, compressed), function(
        err,
        event
      ) {
        if (err) {
  ...
  function(done) {
    zlib.deflate(input, function(err, compressed) {
      ...
      benchmark('zlib.inflate()', zlib.inflate.bind(zlib, compressed), function(
        err,
        event
      ) {
        if (err) {
